...
namespace uLearn.Courses.Linq.Slides.LINQ
{
	...
	public class S110_AggregateFunctions
	{
		...
		*/
		...
		на массивах, списках, хеш-таблицах и многих других структурах данных — `O(1)`.
		*/

		/*
		Есть еще две полезные функции: `All` и `Any`, которые проверяют, выполняется ли заданный предикат для всех элементов
