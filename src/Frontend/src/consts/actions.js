...
export const COURSES__EXERCISE_ADD_SUBMISSION = "COURSES__EXERCISE_ADD_SUBMISSION";
export const COURSES__EXERCISE_ADD_REVIEW_COMMENT = "COURSES__EXERCISE_ADD_REVIEW_COMMENT";
export const COURSES__EXERCISE_DELETE_REVIEW_COMMENT = "COURSES__EXERCISE_DELETE_REVIEW_COMMENT";
