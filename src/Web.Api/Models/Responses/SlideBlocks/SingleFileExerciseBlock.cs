...
{
	[DataContract]
	public class SingleFileExerciseBlockResponse : IApiSlideBlock
	{
		[DefaultValue(false)]
		...
		public SingleFileExerciseBlockResponse(SingleFileExerciseBlock codeBlock, IEnumerable<UserExerciseSubmission> submissions)
		{
			Hints = codeBlock.Hints.ToArray();
			ExerciseInitialCode = codeBlock.ExerciseInitialCode;
			ExerciseCode = codeBlock.ExerciseCode;
		...
		public SingleFileExerciseBlockResponse()
		{
		}
	}
}