...
namespace uLearn.Courses.BasicProgramming.Slides.U01_Mistakes
{
	...
	class S041_RuntimeErrors : SlideTestBase
	{
		...
		Функция должна принимать неотрицательные коэффициенты __a__, __b__, __c__ и, если решение существует, печатать на консоль искомый __x__ , а иначе — строку `Impossible`.
		*/
