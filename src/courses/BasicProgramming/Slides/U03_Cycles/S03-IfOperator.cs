...
{
	[Slide("Оператор условия", "{EB11DFB6-5629-4D13-819B-6411B9F93DF6}")]
	class S03_IfOperator
	{
		...
		У него есть предварительный список имён, и теперь он хочет для каждого имени посчитать его "значение".
		И уже отталкиваясь от этих значений, он выберет себе имя пользователя. Каждому имени нужно сопоставить число, вычисляемое таким образом:
		 ...
		 * Если в слове есть буква "q", то:
			 ...
			 * если нет буквы "w", то стоимость увеличивается на 100
			 * если нет буквы "e", то стоимость увеличивается на 150
