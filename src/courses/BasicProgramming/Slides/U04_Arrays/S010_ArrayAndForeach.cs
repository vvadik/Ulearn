...
namespace Slide01
{
	...
	public class S010_ArrayAndForeach
	{
		...
		*/
		...
		/* 
		### Общее правило по выбору типа цикла:
			
		*	Нужно сделать что-то с каждым элементом массива — **foreach**.
		*	Заранее известно сколько раз нужно повторить действие — **for**.
		*	Есть переменная, изменяемая каждую итерацию и у нее есть понятный смысл — **for**.
		*	Иначе — **while**.
		*/
	}
}