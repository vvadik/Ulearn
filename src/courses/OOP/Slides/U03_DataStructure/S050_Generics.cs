...
namespace OOP.Slides.U03_DataStructure
{
    ...
    public class S050_Generics
    {
        ...
        */
        ...
        /*
        В данном примере TKey и TValue называются параметризуемыми типами. IAssociativeArray<TKey, TValue> - называется обобщенным типом.
        Парадигма обобщенного программирования подразумевает возможность накладывания некоторых ограничений для параметризуемых типов.
        Например, потребовать наличие возможности упорядочить или отсортировать экземпляры класса TKey:
        */
        ...
        /*
        В данном примере мы накладываем на TKey следующее ограничение: он должен реализовывать интерфейс IComparable<TKey>. 
