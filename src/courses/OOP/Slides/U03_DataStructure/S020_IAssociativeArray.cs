...
namespace OOP.Slides.U03_DataStructure
{
	...
	{
		/*
		Реализуйте ассоциативный массив, где ключом является строка, а значением целое число, с помощью хэш-таблицы, самобалансирующегося дерева поиска (выбрать из предложенных) или списка с пропусками:
		*/
