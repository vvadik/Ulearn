...
namespace OOP.Slides.U03_DataStructure
{
	...
	public class S020_IAssociativeArray
	{
        ...
        Необходимо реализовать ассоциативный массив, где ключем является строка, а значением - целое число, с помощью хэш-таблицы, самобалансирующегося дерева поиска(выбрать из предложенных) или списка с пропусками:
        */
