...
namespace OOP.Slides.U03_DataStructure
{
    ...
    public class S070_Mocks
    {
        ...
        */
        ...
        /*
        Такие тестовые реализации называются [Mock-объектами](https://en.wikipedia.org/wiki/Mock_object). Минусом данного подхода является то, что постоянно приходится писать однообразные тестовые реализации.
