...
namespace OOP.Slides.U03_DataStructure
{
	...
	public class S010_AssociativeArray
	{
        ...
        * REMOVE(ключ)
        ...
        ### Реализация
        При реализация какой-либо операции как правило пытаются оценивать некоторые ее свойства. Например: сколько места она занимает места и какова ассимптотическая сложность операций. 
        ...
        * Красно-черное дерево
        Так же стоит отметить сложность операций: для всех трех операций - O(logN). 
