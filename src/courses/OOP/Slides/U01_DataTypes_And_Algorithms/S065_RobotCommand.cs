...
namespace OOP.Slides.U01_DataTypes_And_Algorithms
{
	...
	public class S065_RobotCommand
	{
		...
		Методы способны возвращать лишь одно значение, и если фактически нужно вернуть несколько — приходится объединять их в DTO.
		В частности функция планирования движения робота может просто возвращать экземлпяр RobotCommand:
		...
		пушка или людой другой актуатор, которым тоже нужно управлять.
