...
namespace OOP.Slides
{
	...
	public class S020_ImmutableClass
	{
		...
		Для этого ни один метод-операция не должен менять объект. Вместо этого каждый метод-операция должен возвращать __новый__ вектор в качестве результата применения операции.
