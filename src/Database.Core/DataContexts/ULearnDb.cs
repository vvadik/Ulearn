...
namespace Database.DataContexts
{
	public class ULearnDb : IdentityDbContext<ApplicationUser>
	{
		...
		private static void CancelCascaseDeleting<T1, T2, T3>(ModelBuilder modelBuilder, Expression<Func<T1, T2>> oneWay, Expression<Func<T1, T3>> secondWay, bool isRequired=true)
			where T1 : class
			where T2 : class
		{
