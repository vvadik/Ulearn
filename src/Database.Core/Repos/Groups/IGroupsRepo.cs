...
namespace Database.Repos.Groups
{
	public interface IGroupsRepo
	{
		...
		Task<GroupMember> AddUserToGroupAsync(int groupId, ApplicationUser user);
		...
		Task<List<Group>> GetMyGroupsFilterAccessibleToUserAsync(string courseId, ClaimsPrincipal user, bool includeArchived = false);
		...
		Task<bool> GetDefaultProhibitFurtherReviewForUserAsync(string courseId, string userId, ClaimsPrincipal instructor);
