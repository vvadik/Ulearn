...
namespace uLearn.Web.Models
{
	public class BlockRenderContext
	{
		...
		public BlockRenderContext(Course course, Slide slide, string baseUrl, dynamic[] blockData, bool isGuest = false, bool revealHidden = false, ManualQuizChecking manualQuizCheckQueueItem = null, bool canUserFillQuiz = false)
		{
