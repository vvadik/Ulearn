namespace uLearn.Web.Migrations
{
    ...
    public partial class SlideIdIsGuid : DbMigration
    {
        public override void Up()
        {
			...
			Sql("UPDATE dbo.Comments SET SlideId = SUBSTRING(SlideId, 1, 8) + '-' + SUBSTRING(SlideId, 9, 4) + '-' + SUBSTRING(SlideId, 13, 4) + '-' + SUBSTRING(SlideId, 17, 4) + '-' + SUBSTRING(SlideId, 21, 12) WHERE LEN(SlideId) = 32");
			AlterColumn("dbo.Comments", "SlideId", c => c.Guid(nullable: false));
			Sql("UPDATE dbo.UserQuestions SET SlideId = SUBSTRING(SlideId, 1, 8) + '-' + SUBSTRING(SlideId, 9, 4) + '-' + SUBSTRING(SlideId, 13, 4) + '-' + SUBSTRING(SlideId, 17, 4) + '-' + SUBSTRING(SlideId, 21, 12) WHERE LEN(SlideId) = 32");
			...
			Sql("UPDATE dbo.UserSolutions SET SlideId = SUBSTRING(SlideId, 1, 8) + '-' + SUBSTRING(SlideId, 9, 4) + '-' + SUBSTRING(SlideId, 13, 4) + '-' + SUBSTRING(SlideId, 17, 4) + '-' + SUBSTRING(SlideId, 21, 12) WHERE LEN(SlideId) = 32");
			AlterColumn("dbo.UserSolutions", "SlideId", c => c.Guid(nullable: false));
			Sql("UPDATE dbo.SlideHints SET SlideId = SUBSTRING(SlideId, 1, 8) + '-' + SUBSTRING(SlideId, 9, 4) + '-' + SUBSTRING(SlideId, 13, 4) + '-' + SUBSTRING(SlideId, 17, 4) + '-' + SUBSTRING(SlideId, 21, 12) WHERE LEN(SlideId) = 32");
			AlterColumn("dbo.SlideHints", "SlideId", c => c.Guid(nullable: false));
			Sql("UPDATE dbo.LtiSlideRequests SET SlideId = SUBSTRING(SlideId, 1, 8) + '-' + SUBSTRING(SlideId, 9, 4) + '-' + SUBSTRING(SlideId, 13, 4) + '-' + SUBSTRING(SlideId, 17, 4) + '-' + SUBSTRING(SlideId, 21, 12) WHERE LEN(SlideId) = 32");
			AlterColumn("dbo.LtiSlideRequests", "SlideId", c => c.Guid(nullable: false));
			Sql("UPDATE dbo.SlideRates SET SlideId = SUBSTRING(SlideId, 1, 8) + '-' + SUBSTRING(SlideId, 9, 4) + '-' + SUBSTRING(SlideId, 13, 4) + '-' + SUBSTRING(SlideId, 17, 4) + '-' + SUBSTRING(SlideId, 21, 12) WHERE LEN(SlideId) = 32");
			AlterColumn("dbo.SlideRates", "SlideId", c => c.Guid(nullable: false));
	        Sql("UPDATE dbo.UserQuizs SET SlideId = SUBSTRING(SlideId, 1, 8) + '-' + SUBSTRING(SlideId, 9, 4) + '-' + SUBSTRING(SlideId, 13, 4) + '-' + SUBSTRING(SlideId, 17, 4) + '-' + SUBSTRING(SlideId, 21, 12) WHERE LEN(SlideId) = 32");
			AlterColumn("dbo.UserQuizs", "SlideId", c => c.Guid(nullable: false));
			Sql("UPDATE dbo.Visits SET SlideId = SUBSTRING(SlideId, 1, 8) + '-' + SUBSTRING(SlideId, 9, 4) + '-' + SUBSTRING(SlideId, 13, 4) + '-' + SUBSTRING(SlideId, 17, 4) + '-' + SUBSTRING(SlideId, 21, 12) WHERE LEN(SlideId) = 32");
        ...
        public override void Down()
        {
			...
			Sql("UPDATE dbo.UserQuizs SET SlideId = SUBSTRING(SlideId, 1, 8) + SUBSTRING(SlideId, 10, 4) + SUBSTRING(SlideId, 15, 4) + SUBSTRING(SlideId, 20, 4) + SUBSTRING(SlideId, 25, 12)");
