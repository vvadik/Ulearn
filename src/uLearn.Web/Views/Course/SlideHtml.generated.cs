...
WriteAttributeTo(__razor_helper_writer, "class", Tuple.Create(" class=\"", 1846), Tuple.Create("\"", 1859)
, Tuple.Create(Tuple.Create("", 1854), Tuple.Create<System.Object, System.Int32>(mark
, 1854), false)
);

WriteAttributeTo(__razor_helper_writer, "style", Tuple.Create(" style=\"", 1860), Tuple.Create("\"", 1874)
, Tuple.Create(Tuple.Create("", 1868), Tuple.Create<System.Object, System.Int32>(style
, 1868), false)
);
...
WriteAttributeTo(__razor_helper_writer, "max", Tuple.Create(" max=\"", 2457), Tuple.Create("\"", 2478)
, Tuple.Create(Tuple.Create("", 2463), Tuple.Create<System.Object, System.Int32>(block.MaxScore
, 2463), false)
);

WriteAttributeTo(__razor_helper_writer, "name", Tuple.Create(" name=\"", 2479), Tuple.Create("\"", 2511)
, Tuple.Create(Tuple.Create("", 2486), Tuple.Create("quiz__score__", 2486), true)
                        , Tuple.Create(Tuple.Create("", 2499), Tuple.Create<System.Object, System.Int32>( block.Id
, 2499), false)
);
...
WriteAttributeTo(__razor_helper_writer, "src", Tuple.Create(" src=\"", 4108), Tuple.Create("\"", 4166)
, Tuple.Create(Tuple.Create("", 4114), Tuple.Create<System.Object, System.Int32>(string.Format("{0}/{1}", context.BaseUrl, imageUrl)
, 4114), false)
);

WriteAttributeTo(__razor_helper_writer, "alt", Tuple.Create(" alt=\"", 4167), Tuple.Create("\"", 4182)
         , Tuple.Create(Tuple.Create("", 4173), Tuple.Create<System.Object, System.Int32>(imageUrl
, 4173), false)
);
...
WriteAttributeTo(__razor_helper_writer, "class", Tuple.Create(" class=\"", 7049), Tuple.Create("\"", 7098)
, Tuple.Create(Tuple.Create("", 7057), Tuple.Create("quiz-block-mark", 7057), true)
, Tuple.Create(Tuple.Create(" ", 7072), Tuple.Create<System.Object, System.Int32>(typeInp
, 7073), false)
, Tuple.Create(Tuple.Create(" ", 7081), Tuple.Create<System.Object, System.Int32>(typeInp
, 7082), false)
, Tuple.Create(Tuple.Create("", 7090), Tuple.Create("-default", 7090), true)
);

WriteAttributeTo(__razor_helper_writer, "id", Tuple.Create(" id=\'", 7099), Tuple.Create("\'", 7131)
, Tuple.Create(Tuple.Create("", 7104), Tuple.Create<System.Object, System.Int32>( block.Id + "_quizBlock"
, 7104), false)
);
...
WriteAttributeTo(__razor_helper_writer, "for", Tuple.Create(" for=\"", 8065), Tuple.Create("\"", 8107)
...
WriteAttributeTo(__razor_helper_writer, "title", Tuple.Create(" title=\"", 8348), Tuple.Create("\"", 8362)
      , Tuple.Create(Tuple.Create("", 8356), Tuple.Create<System.Object, System.Int32>(title
, 8356), false)
);
...
WriteAttributeTo(__razor_helper_writer, "class", Tuple.Create(" class=\"", 9400), Tuple.Create("\"", 9429)
, Tuple.Create(Tuple.Create("", 9408), Tuple.Create("form-control", 9408), true)
, Tuple.Create(Tuple.Create(" ", 9420), Tuple.Create<System.Object, System.Int32>(quizRes
, 9421), false)
);

WriteAttributeTo(__razor_helper_writer, "id", Tuple.Create(" id=\'", 9430), Tuple.Create("\'", 9461)
, Tuple.Create(Tuple.Create("", 9435), Tuple.Create<System.Object, System.Int32>( block.Id + "quizBlock"
, 9435), false)
);

WriteAttributeTo(__razor_helper_writer, "maxlength", Tuple.Create(" maxlength=\"", 9462), Tuple.Create("\"", 9508)
                   , Tuple.Create(Tuple.Create("", 9474), Tuple.Create<System.Object, System.Int32>(QuizController.MaxFillinblockSize
, 9474), false)
);
...
WriteAttributeTo(__razor_helper_writer, "id", Tuple.Create(" id=\"", 11304), Tuple.Create("\"", 11336)
...
WriteAttributeTo(__razor_helper_writer, "class", Tuple.Create(" class=\"", 11544), Tuple.Create("\"", 11566)
, Tuple.Create(Tuple.Create("", 11552), Tuple.Create<System.Object, System.Int32>(trueItemClass
, 11552), false)
);

WriteAttributeTo(__razor_helper_writer, "title", Tuple.Create(" title=\"", 11567), Tuple.Create("\"", 11582)
, Tuple.Create(Tuple.Create("", 11575), Tuple.Create<System.Object, System.Int32>(ttitle
, 11575), false)
);

WriteAttributeTo(__razor_helper_writer, "for", Tuple.Create(" for=\"", 11583), Tuple.Create("\"", 11624)
, Tuple.Create(Tuple.Create("", 11589), Tuple.Create<System.Object, System.Int32>( block.Id + "quizBlock" + "True"
, 11589), false)
);
...
WriteAttributeTo(__razor_helper_writer, "title", Tuple.Create(" title=\"", 11827), Tuple.Create("\"", 11842)
, Tuple.Create(Tuple.Create("", 11835), Tuple.Create<System.Object, System.Int32>(ttitle
, 11835), false)
);
...
WriteAttributeTo(__razor_helper_writer, "class", Tuple.Create(" class=\"", 12071), Tuple.Create("\"", 12094)
, Tuple.Create(Tuple.Create("", 12079), Tuple.Create<System.Object, System.Int32>(falseItemClass
, 12079), false)
);

WriteAttributeTo(__razor_helper_writer, "title", Tuple.Create(" title=\"", 12095), Tuple.Create("\"", 12110)
, Tuple.Create(Tuple.Create("", 12103), Tuple.Create<System.Object, System.Int32>(ftitle
, 12103), false)
);

WriteAttributeTo(__razor_helper_writer, "for", Tuple.Create(" for=\"", 12111), Tuple.Create("\"", 12153)
, Tuple.Create(Tuple.Create("", 12117), Tuple.Create<System.Object, System.Int32>( block.Id + "quizBlock" + "False"
, 12117), false)
);
...
WriteAttributeTo(__razor_helper_writer, "title", Tuple.Create(" title=\"", 12359), Tuple.Create("\"", 12374)
, Tuple.Create(Tuple.Create("", 12367), Tuple.Create<System.Object, System.Int32>(ftitle
, 12367), false)
);
...
WriteAttributeTo(__razor_helper_writer, "class", Tuple.Create(" class=\"", 13120), Tuple.Create("\"", 13196)
, Tuple.Create(Tuple.Create("", 13128), Tuple.Create("quiz-block-ordering", 13128), true)
, Tuple.Create(Tuple.Create(" ", 13147), Tuple.Create<System.Object, System.Int32>( context.CanUserFillQuiz ? "" : "not-movable"
, 13148), false)
);

WriteAttributeTo(__razor_helper_writer, "id", Tuple.Create(" id=\'", 13197), Tuple.Create("\'", 13229)
          , Tuple.Create(Tuple.Create("", 13202), Tuple.Create<System.Object, System.Int32>( block.Id + "_quizBlock"
, 13202), false)
);
...
WriteAttributeTo(__razor_helper_writer, "id", Tuple.Create(" id=\'", 14018), Tuple.Create("\'", 14066)
, Tuple.Create(Tuple.Create("", 14023), Tuple.Create<System.Object, System.Int32>( block.Id + "quizBlock" + item.GetHash()
, 14023), false)
);
...
WriteAttributeTo(__razor_helper_writer, "class", Tuple.Create(" class=\"", 15370), Tuple.Create("\"", 15446)
, Tuple.Create(Tuple.Create("", 15378), Tuple.Create("quiz-block-matching", 15378), true)
, Tuple.Create(Tuple.Create(" ", 15397), Tuple.Create<System.Object, System.Int32>( context.CanUserFillQuiz ? "" : "not-movable"
, 15398), false)
);

WriteAttributeTo(__razor_helper_writer, "id", Tuple.Create(" id=\'", 15447), Tuple.Create("\'", 15479)
          , Tuple.Create(Tuple.Create("", 15452), Tuple.Create<System.Object, System.Int32>( block.Id + "_quizBlock"
, 15452), false)
);
...
WriteAttributeTo(__razor_helper_writer, "class", Tuple.Create(" class=\"", 16721), Tuple.Create("\"", 16777)
, Tuple.Create(Tuple.Create("", 16729), Tuple.Create("quiz", 16729), true)
, Tuple.Create(Tuple.Create(" ", 16733), Tuple.Create("quiz-block-matching__item", 16734), true)
, Tuple.Create(Tuple.Create(" ", 16759), Tuple.Create<System.Object, System.Int32>(isRightClass
, 16760), false)
, Tuple.Create(Tuple.Create(" ", 16773), Tuple.Create("row", 16774), true)
);
...
WriteAttributeTo(__razor_helper_writer, "id", Tuple.Create(" id=\'", 16812), Tuple.Create("\'", 16877)
, Tuple.Create(Tuple.Create("", 16817), Tuple.Create<System.Object, System.Int32>( block.Id + "quizBlock" + fixedItem.GetHashForFixedItem()
, 16817), false)
);
...
WriteAttributeTo(__razor_helper_writer, "class", Tuple.Create(" class=\"", 20166), Tuple.Create("\"", 20293)
, Tuple.Create(Tuple.Create("", 20174), Tuple.Create("try-again-button", 20174), true)
, Tuple.Create(Tuple.Create(" ", 20190), Tuple.Create("btn", 20191), true)
, Tuple.Create(Tuple.Create(" ", 20194), Tuple.Create("btn-primary", 20195), true)
, Tuple.Create(Tuple.Create(" ", 20206), Tuple.Create("no-rounds", 20207), true)
, Tuple.Create(Tuple.Create(" ", 20216), Tuple.Create("exercise-version-link", 20217), true)
                         , Tuple.Create(Tuple.Create(" ", 20238), Tuple.Create<System.Object, System.Int32>( model.IsLti ? "exercise-controls_button-long" : ""
, 20239), false)
);
...
WriteAttributeTo(__razor_helper_writer, "class", Tuple.Create(" class=\"", 20387), Tuple.Create("\"", 20495)
, Tuple.Create(Tuple.Create("", 20395), Tuple.Create("run-solution-button", 20395), true)
, Tuple.Create(Tuple.Create(" ", 20414), Tuple.Create("btn", 20415), true)
, Tuple.Create(Tuple.Create(" ", 20418), Tuple.Create("btn-primary", 20419), true)
, Tuple.Create(Tuple.Create(" ", 20430), Tuple.Create("no-rounds", 20431), true)
      , Tuple.Create(Tuple.Create(" ", 20440), Tuple.Create<System.Object, System.Int32>( model.IsLti ? "exercise-controls_button-long" : ""
, 20441), false)
);
...
WriteAttributeTo(__razor_helper_writer, "class", Tuple.Create(" class=\"", 20950), Tuple.Create("\"", 21053)
, Tuple.Create(Tuple.Create("", 20958), Tuple.Create("show-output-button", 20958), true)
, Tuple.Create(Tuple.Create(" ", 20976), Tuple.Create("btn", 20977), true)
, Tuple.Create(Tuple.Create(" ", 20980), Tuple.Create("btn-default", 20981), true)
, Tuple.Create(Tuple.Create(" ", 20992), Tuple.Create("no-rounds", 20993), true)
         , Tuple.Create(Tuple.Create(" ", 21002), Tuple.Create<System.Object, System.Int32>( model.IsShowOutputButtonActive ? "active" : ""
, 21003), false)
);
...
WriteAttributeTo(__razor_helper_writer, "onclick", Tuple.Create(" onclick=\"", 21231), Tuple.Create("\"", 21274)
            , Tuple.Create(Tuple.Create("", 21241), Tuple.Create<System.Object, System.Int32>( model.AcceptedSolutionsAction
, 21241), false)
);
