...
WriteAttributeTo(__razor_helper_writer, "src", Tuple.Create(" src=\'", 1637), Tuple.Create("\'", 1650)
, Tuple.Create(Tuple.Create("", 1643), Tuple.Create<System.Object, System.Int32>(jsFile
, 1643), false)
);
